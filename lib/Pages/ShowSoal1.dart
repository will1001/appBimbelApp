    ...
    if (_popUpMessage != "Waktu Habis") {
      widgetButton = [
        Padding(
          ...
          child: buttonStyle1(context, 100, 'Ya', Color(0xFFF6F5FF),Colors.black, () {
            hitungNilai();
          }),
        ),
        Padding(
          padding: const EdgeInsets.only(right: 18.0),
          child: buttonStyle1(context, 100, 'Tidak', Color(0xFFF6F5FF),Colors.black, () {
            startOrStopTimer();
            if (mounted) {
              setState(() {
                _showPopUp = false;
      ...
      widgetButton = [
        buttonStyle1(context, 100, 'Lihat Nilai', Color(0xFFF6F5FF),Colors.black, () {
          hitungNilai();
        }),
      ];
    }
                        ...
                        Padding(
                          ...
                          child: ListView(
                            ...
                            children: [
                              ...
                              //     _listJawaban,
                              //     _nomor,
                              //     latexView(nullStringReplacer(
                              //         _listSoal[_nomor - 1]['pil_a']),context), () {
                              //   if (mounted) {
                              //     setState(() {
                              ...
                              //     _nomor,
                              //     latexView(nullStringReplacer(
                              //         _listSoal[_nomor - 1]['pil_b']),context), () {
                              //   if (mounted) {
                              //     setState(() {
                              ...
                              //     _nomor,
                              //     latexView(nullStringReplacer(
                              //         _listSoal[_nomor - 1]['pil_c']),context), () {
                              //   if (mounted) {
                              //     setState(() {
                              ...
                              //     _nomor,
                              //     latexView(nullStringReplacer(
                              //         _listSoal[_nomor - 1]['pil_d']),context), () {
                              //   if (mounted) {
                              //     setState(() {
                              ...
                              //     _nomor,
                              //     latexView(nullStringReplacer(
                              //         _listSoal[_nomor - 1]['pil_e']),context), () {
                              //   if (mounted) {
                              //     setState(() {
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Opacity(
                                      ...
                                      child: buttonStyle1(context, 100,
                                          'Pembahasan', Colors.white,Colors.black, () {
                                    ...
                                    Opacity(
                                      ...
                                      child: buttonStyle1(context, 100,
                                          'Sebelumnya', Colors.white,Colors.black, () {
                                        if (_nomor != 1) {
                                          if (mounted) {
                                            setState(() {
                                              _nomor -= 1;
                                    ...
                                    _nomor == _listSoal.length
                                        ...
                                        : buttonStyle1(context, 100,
                                            'Selanjutnya', Colors.white, Colors.black,() {
                                            if (mounted) {
                                              setState(() {
                                                _nomor += 1;
                                              });
